  ...
  return (
    ...
    <div className="card text-center  animate__animated animate__fadeInUp">
      ...
      <div className="card-body " style={{fontFamily:"Open Sans sans-serif"}}>
        <h4 className="card-title" style={{fontFamily:"Open Sans sans-serif"}}>{title}</h4>
        ...
        <a
          href={url ? url : "#!"}
          target="_blank"
          className="btn btn-outline-black border-2 " style={{fontSize:"20px", fontFamily:"Open Sans sans-serif", backgroundColor:"red", color:"white"}}
          rel="noreferrer"
        >
          Go to {title}
        </a>
